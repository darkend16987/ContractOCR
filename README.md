...
**Tìm & Thay thế chữ trong cả tài liệu (Ctrl+H)** — như Word: gõ từ khoá, app quét toàn bộ tài liệu và tô sáng mọi vị trí kèm số đếm, rồi **Thay** từng chỗ lần lượt từ trên xuống (bỏ qua chỗ nào cũng được) hoặc **Thay tất cả** trong một lần, hoàn tác bằng một Ctrl+Z; có **phân biệt hoa/thường** và **đúng nguyên từ**; từ khoá bị chia làm nhiều đoạn định dạng được **tô riêng màu vàng và nói rõ là không thay tự động** thay vì bỏ qua im lặng ·
**nén (đã bỏ trần 200MB — file lớn đi đường nhị phân, không còn base64)** · **in (kết nối máy in — khổ A4…A0, chọn khoảng trang, mỗi trang luôn gọn trong một tờ)** · so sánh 2 file
