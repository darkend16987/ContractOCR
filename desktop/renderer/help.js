      ...
      blocks: [
        ...
        { h: T("Từng công cụ một", "Tool by tool") },
        {
          ul: [
            ...
            T("**Khoanh vùng chữ nhật** (`R`) và **elip / tròn** (`O`) — kéo để khoanh. Đổi **Nền** và **Mờ nền** nếu muốn tô màu bên trong; bỏ tick **Trong suốt** để bật nền.", "**Rectangle** (`R`) and **ellipse / circle** (`O`) — drag to draw. Use **Nền** and **Mờ nền** to fill it; untick **Trong suốt** to enable the fill."),
            T(
