...
const FEATURES = [
  ...
  { i: "pen", t: "Chú thích & đánh dấu", d: "Hộp văn bản, ghi chú, mũi tên, khoanh mây revision, tô sáng, vẽ tay, che thông tin, watermark, chữ ký ảnh — sửa, di chuyển và xoá lại được cả sau khi đã lưu, kể cả trên trang đã xoay như bản vẽ khổ ngang." },
